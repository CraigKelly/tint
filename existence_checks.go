...
func ShouldNotExist() []*BadTerm {
	// For now this is just hard-coded (until we have ways of enabling or
	// disabling certain checks)
	return []*BadTerm{
		// Skunked terms
		{"bona fides", "'%s' has issues - rephrase."},
		{"deceptively", "'%s' has issues - rephrase."},
		{"decimate", "'%s' has issues - rephrase."},
		{"effete", "'%s' has issues - rephrase."},
		...
		{"begat", "'%s' is archaic."},
		{"belike", "'%s' is archaic."},
		{"betimes", "'%s' is archaic."},
		{"boughten", "'%s' is archaic."},
		{"brocage", "'%s' is archaic."},
		{"brokage", "'%s' is archaic."},
		...
		{"cozen", "'%s' is archaic."},
		{"divers", "'%s' is archaic."},
		{"deflexion", "'%s' is archaic."},
		{"durst", "'%s' is archaic."},
		{"fain", "'%s' is archaic."},
		{"forsooth", "'%s' is archaic."},
		{"foreclose from", "'%s' is archaic."},
		{"haply", "'%s' is archaic."},
		{"howbeit", "'%s' is archaic."},
		{"illumine", "'%s' is archaic."},
		{"in sooth", "'%s' is archaic."},
		{"maugre", "'%s' is archaic."},
		{"meseems", "'%s' is archaic."},
		{"nigh", "'%s' is archaic."},
		{"peradventure", "'%s' is archaic."},
		{"perchance", "'%s' is archaic."},
		{"saith", "'%s' is archaic."},
		{"shew", "'%s' is archaic."},
		{"sistren", "'%s' is archaic."},
		{"spake", "'%s' is archaic."},
		{"to wit", "'%s' is archaic."},
		{"verily", "'%s' is archaic."},
		{"whilom", "'%s' is archaic."},
		{"withal", "'%s' is archaic."},
		{"wot", "'%s' is archaic."},
		{"enclosed please find", "'%s' is archaic."},
		{"please find enclosed", "'%s' is archaic."},
		{"enclosed herewith", "'%s' is archaic."},
		{"enclosed herein", "'%s' is archaic."},
		{"inforce", "'%s' is archaic."},
		{"ex postfacto", "'%s' is archaic."},
		{"foreclose from", "'%s' is archaic."},
